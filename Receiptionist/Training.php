  ...
  if($_FILES["fileToUpload"]["name"] != NULL){
      ...
      if($ext == "PDF" || $ext == "pdf"){
        ...
        if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../admin-panel/uploads/training/".$filepath)){
          ...
          if($stmt->execute()){
            echo'<script>alert("Applied Successfully !");window.location.href="Training.php";</script>';
          }
...
<?php include 'header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Apply New Training Applicant</h1>
          </div>
        ...
        <div style="">
          ...
          <div class="container-fluid">
                ...
                <!-- Page Heading -->
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">List of Training Applications</h1>
              <p class=" text-info">
