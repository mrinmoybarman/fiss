...
if (isset($_SESSION['Receiptionist_id']) && isset($_SESSION['token'])) {
    header('location:Receiptionist_Home.php');
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Back Receiptionist !</h1>
                  </div>
  ...
  <script type="text/javascript">
            $( "form" ).on( "submit", function( event ) {
              ...
              $.ajax({
                ...
                type:'POST',
                url:'Receiptionist_login_check.php',
                data:$( this ).serialize(),
                success:function(d){
                  if(d==0) {alert("Invalid user id/password");window.location.href="index.php";}
                  else if(d==1) window.location.href="Receiptionist_Home.php";
                }
              });
