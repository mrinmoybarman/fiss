                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      <thead>
                        <tr class="text-white bg-info">
                          ...
                          <th class="text-center">Edit Remarks</th>
                        </tr>
                      </thead>
                      <tbody>
                          <?php
                              ...
                              for($i=0;$i<sizeof($r);$i++){
                                echo '<tr>';
                                  ...
                                  echo '<td>'.$r[$i]['remarks'].'</td>'; 
                                  echo '<td><a href="edit_Remarks.php?id='.$r[$i]['id'].'"><button class="btn btn-success">Edit Remarks</button></a></td>'; 
                                echo '</tr>';
                              }
                            ?>
                      </tbody>
