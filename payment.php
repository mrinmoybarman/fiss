...
$secretKey = "fd4287c7e4bb56bfe6898b8f73e40669a73b8b6a"; // my secret key can be found on the dashboard
$appId = '90645eb069ca842ca575ef89d54609'; //app id generated from the dashboard
...
if($stmt->execute()){
    ...
    $returnUrl = 'https://www.fissecurity.com/PaymentConformation.php'; //after completion of the payment all response will be posted to this page
