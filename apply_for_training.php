...
//   $why = addslashes(strip_tags(trim($_POST['why'])));
  ...
  if($_FILES["fileToUpload"]["name"] != NULL){
      ...
      if($ext == "PDF" || $ext == "pdf" || $ext == "jpg" || $ext == "JPG" || $ext == "jpeg" || $ext == "JPEG" || $ext == "PNG" || $ext == "png"){
        ...
        if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"admin-panel/uploads/training/".$filepath)){

          $sql = "INSERT INTO `training_apply` (`id`, `postname`, `firstname`, `middlename`, `lastname`, `fathersname`, `mothersname`, `gender`, `meritalstatus`, `dob`, `vill1`, `po1`, `ps1`, `dist1`, `state1`, `pin1`, `vill2`, `po2`, `ps2`, `dist2`, `state2`, `pin2`, `phone1`, `whatsapp`, `email`, `cv`, `date`, `expected_salery`, `why`, `order_id`, `app_id`) VALUES (NULL, NULL, '$firstname', '$middlename', '$lastname', '$fathersname ', '$mothersname ', '$gender', '$meritalstatus', '$dob', '$vill1', '$po1', '$ps1', '$dist1', '$state1', '$pin1', '$vill2', '$po2', '$ps2', '$dist2', '$state2', '$pin2', '$phone1', '$phone2', '$email', '$filepath', '$date', NULL, NULL, '$orderId', '$app_id');";
  ...
  <head>
    ...
    <div class="content">
          ...
          <div class="top-content">
            <h1>Apply For Training Now</h1>
            <h4><i>Please Fill Up The Form To Continue</i></h4>
          </div>
          <form method="POST" action="apply_for_training.php" enctype="multipart/form-data">
