...
if(isset($_POST['change']))
{
  ...
  $q = "update admin_login set password=:password where user_id=:user_id";
  $stmt = $core->dbh->prepare($q);
  $stmt->bindParam(':password',$pwd,PDO::PARAM_STR);
  $stmt->bindParam(':user_id',$_SESSION['user_id'],PDO::PARAM_STR);
  if($stmt->execute())
    echo'<script>alert("password changed successfully.Please re login.");window.location.href="config/logout_admin.php";</script>';
  else
