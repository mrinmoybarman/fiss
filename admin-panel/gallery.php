    ...
    <div style="">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">All Destinations</h1>
          <p class=" text-info">
                      ...
                      <?php
                          ...
                          for($i=0;$i<sizeof($r);$i++){
                            echo '<tr>';
                              echo '<td>'.$r[$i]['id'].'</td>';
                              echo '<td>'.$r[$i]['name'].'</td>';
                              echo '<td><img src="uploads/gallery/'.$r[$i]['thumbnail'].'" class="img-thumbnail" width="100px" /></td>';
                              echo '<td><a href="add_image.php?id='.$r[$i]['id'].'"><i class="fa fa-trash" aria-hidden="true"></i>
                              </a></td>';
                            echo '</tr>';
                          }
                        ?>
